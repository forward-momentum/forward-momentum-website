...
if (posthog) {
  try {
    posthog.init(process.env.POSTHOG_CLIENT_ID, { api_host: process.env.POSTHOG_URL });
  } catch (e) {
    console.error(e)
  }
}
...
export const AnalyticsProvider = (props) => <AnalyticsContext.Provider value={analytics} {...props} />